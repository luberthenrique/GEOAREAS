...
@Component({
  selector: 'app-new-area-entrega',
  templateUrl: './new-area-entrega.component.html',
  styleUrls: ['./new-area-entrega.component.css']
})
export class NewAreaEntregaComponent implements OnInit, AfterViewInit {
  ...
  onSubmit() {
    ...
    this.service.inserir(areaEntrega)
      .pipe(first())
      .subscribe(
        data => {
