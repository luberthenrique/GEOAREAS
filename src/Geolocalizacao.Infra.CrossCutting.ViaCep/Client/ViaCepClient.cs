using Geolocalizacao.Infra.CrossCutting.ViaCep.Models;
using System;
...
namespace Geolocalizacao.Infra.CrossCutting.ViaCep.Client
{
    /// <summary>
    ...
    public class ViaCepClient : IViaCepClient
    {
        ...
        public async Task<ViaCepResult> SearchAsync(string zipCode, CancellationToken cancellationToken)
        {
            ...
            return JsonSerializer.Deserialize<ViaCepResult>(json);
        }
